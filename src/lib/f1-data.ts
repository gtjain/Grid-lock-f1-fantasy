...
export const RACES = [
    { id: 1, name: "Australian Grand Prix", venue: "Melbourne", country: "Australia", flag: "🇦🇺", date: "Mar 08, 2026", time: "09:30 AM UTC", status: "completed", results: { top3: ["Max Verstappen", "Lando Norris", "Charles Leclerc"], winningTeam: "Red Bull Racing" } },
    { id: 2, name: "Chinese Grand Prix", venue: "Shanghai", country: "China", flag: "🇨🇳", date: "Mar 22, 2026", time: "12:30 PM UTC", status: "completed", sprint: true, results: { top3: ["Lando Norris", "Max Verstappen", "Oscar Piastri"], winningTeam: "McLaren" } },
